...
class CustomOCUCB(object):
    ...
    def CustomOCUCB(self, users, numActions, readfile, writefile):
        ...
        f = open(writefile+'testRegretCustomOCUCB0RR1.txt', 'a')
...
if __name__ == "__main__":
    ...
    for turn in range(0,1):
        ...
        cumulativeReward, bestActionCumulativeReward, regret, arm, timestep, bestSet = obj.CustomOCUCB(users,actions,readfile,writefile)
        ...
        f = open(writefile + 'testCustomOCUCB0RR1.txt', 'a')
