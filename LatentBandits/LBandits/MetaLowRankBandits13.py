...
class MetaLowRankBandit(object):
    ...
    def updateWeight(self, user):
        ...
        xj[self.a[0]] = (r1/(self.user_bandit_prob[user][0]*self.prob[0][self.a[0]]))
        ...
        xj = [0.0 for col in range(0,self.numActions)]
        xj[self.a[1]] = (r2/(self.user_bandit_prob[user][0]*self.prob[1][self.a[1]]))
    ...
    def MetaLowRankBandit(self, users, numActions, rank, readfile, writefile, filename):
        ...
        while True:
            ...
            if isnan(sum(self.user_bandit_prob[self.user_nature])) == True:
            ...
            if self.meta_action_taken == 2:
                ...
                for count in range(0,self.rank):
                    ...
                    xj[self.meta_action_taken] = ((self.R[count])/(self.user_bandit_prob[self.user_nature][self.meta_action_taken]))
