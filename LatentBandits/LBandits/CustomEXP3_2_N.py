...
class CustomEXP3(object):
    ...
    def CustomEXP3(self, users, numActions, rank, readfile, writefile):
        ...
        while True:
            ...
            for d in range(0,self.rank):
                ...
                self.aS.add(action)
                self.bestSetAction.add(self.bestAction[user])
                ...
                for col in range(0,self.numActions):
                    ...
                    if col == action:
                        loss[col] = (1.0 - theReward) / self.prob[user][col]
                        self.cumulativeLoss[user][col] += loss[col]
            ...
            if self.t % 5000 == 0:
                print "At time: " + str(self.t), ", action: " +str(self.aS), ", best: " + str(self.bestSetAction) , ", regret:", str(regret)
...
if __name__ == "__main__":
    ...
    for turn in range(0,1):
        ...
        cumulativeReward, bestActionCumulativeReward, regret, arm, timestep, bestSet = obj.CustomEXP3(users,actions,rank,readfile,writefile)
