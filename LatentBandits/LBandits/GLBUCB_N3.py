...
class GLBUCB(object):
    ...
    def upperBound(self):
        ...
        # Noisy
        return math.sqrt(math.log((self.psi*self.numRounds*self.epsilon*self.epsilon))/(16.0*self.nm))
    ...
    def find_best_cols1(self):
        ...
        while True:
            ...
            if len(self.selectCol) >= self.explore:
                break
            elif len(self.selectCol) >= self.rank:
                break
            else:
                col = random.randint(0,self.numActions-1)
                if self.B[col]!= -1 and col not in self.selectCol:
                    self.selectCol.append(random.randint(0,self.numActions-1))
        
                
        print "best col: " + str(self.bestCol)  
        print "Select col: " + str(self.selectCol)  
    '''
    ...
    def colElim1(self):
        ...
        for user in range(0,self.users):
            ...
            for col in range(0,self.numActions):
                ...
                if self.estR[user][col] != self.MIN and self.estR[user][col] > max_val:
            ...
            if self.remArmsUser(user) > 1:
                ...
                for col in range(0,self.numActions):
                    ...
                    if col!=max_index and self.estR[user][col]!= self.MIN and self.B[col]!= -1 and self.B1[user][col]!= -1 and self.estR[user][col]+ self.upperBound() < self.estR[user][max_index] - self.upperBound():
    ...
    def GLBUCB(self, users, numActions, rank, readfile):
        ...
        while True:
            ...
            if self.remArms() > self.rank:
                ...
                elif self.t <= self.Nm and self.t >= self.Nmx and self.flag == True: 
                ...
                #Explore 2nd half   
                    ...
                    for i in range(0,self.numActions):
                        ...
                        col = random.randint(0,self.numActions - 1)
                        if col in self.bestCol and self.B1[self.user_nature][col]!=-1:
                            self.action = col
                            break
                ...
                #Exploit
                    ...
                    self.action = max(range(0,self.numActions), key=lambda col: self.estR[self.user_nature][col])
