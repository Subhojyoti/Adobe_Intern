...
class GLBUCB(object):
    ...
    def find_best_cols1(self):
        ...
        self.bestActionSet = []
        for col in range(0,self.rank):
            self.bestActionSet.append(ind[col])
    ...
    def colElim1(self):
        ...
        for col1 in range(0,self.numActions): 
            ...
            for col in self.bestActionSet:
                ...
                if col1 not in self.bestActionSet and col1 != col:
                    
                    user_count = 0
                    user_total_seen = 0
                    for user in range(0,self.users):
                        
                        if self.numPlays[user][col] > 0 and self.numPlays[user][col1] > 0:
                            user_total_seen += 1
                            if self.estR[user][col] - self.upperBound(user, col) > self.estR[user][col1] + self.upperBound(user, col1):
                            
                                user_count = user_count + 1
                                #print user_count, user_total_seen
                            
                            
                    #if user_count >= user_total_seen:
                    if user_count >= self.explore:
                        self.B[col1] = -1
                        print "remove: "+str(col1)+ ". Remaining columns: " + str(self.B)
                                
                                        
                        for u in range(0,self.users):
                            self.estR[u][col1] = self.MIN
                            self.ucbs[u][col1] = self.MIN
                            self.B1[u][col1] = -1  
    ...
    def GLBUCB(self, users, numActions, rank, readfile):
        ...
        self.bestActionSet = [self.numActions-1,self.numActions-2]
        print self.bestCol
        print self.bestActionSet
        ...
        f = open('NewExpt/expt12/testRegretGLBUCB0RR1.txt', 'a')
...
if __name__ == "__main__":
    ...
    for turn in range(0,1):
        ...
        f = open('NewExpt/expt12/testGLBUCB0RR1.txt', 'a')
