...
class MetaLowRankBandit(object):
    ...
    def metaBanditEXP3(self):
        ...
        '''
        if len(sets.Set(self.bestActionSetUnique)) < self.rank:
            
            print "bA: " + str(self.bestActionSet)
            print self.bestActionSetUnique
            sys.exit(0)
        '''
    ...
    def updateWeight(self):
        ...
        xj[self.a[0]] = (r1/(self.epsilon*self.prob[0][self.a[0]]))
        ...
        xj = [0.0 for col in range(0,self.numActions)]
        xj[self.a[1]] = (r2/(self.epsilon*self.prob[1][self.a[1]]))
    ...
    def MetaLowRankBandit(self, users, numActions, rank, readfile, writefile, filename):
        ...
        while True:
            ...
            #self.epsilon = 1.0/(math.sqrt(self.t + 1.0))
            ...
            #self.epsilon = 0.3/(math.sqrt(math.log(self.t + 2.0)))
            self.epsilon = 1.0/(math.pow((self.t + 1), 0.16))
            #self.epsilon = 0.1
            
            if num1 < self.epsilon:
                self.R = []
                self.a = []
                ...
                for count in range(0,self.rank):
                    ...
                    #print self.user_nature, col
                        ...
                        self.lcbs[self.user_nature][col] = self.estR[self.user_nature][col] - self.upperBound(self.numPlays[self.user_nature][col])
            ...
            if self.t % 1000 == 0:
                ...
                print self.bestActionSet, self.epsilon
...
if __name__ == "__main__":
    ...
    actions = 64
    rank = 2
    readfile = "env/env2/AP3.txt"
    writefile = "NewExpt1/expt3/"
    filename = 'MetaEXP0RR2.txt'
